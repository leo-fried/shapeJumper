...
class Player
{
    ...
    public:
        Player() : posX(10), completedLevels{false, false, false}, coinsCollected{{0,0,0}, {0,0,0}, {0,0,0}}, totalAttempts{0,0,0}, levelPct{0,0,0}, alive(true), deltaY(1), height(DEFAULT_HEIGHT), isJumping(false), posY(0), gravity(false) { loadData(); }
